...
from YUVICHATBOT.idchatbot.helpers import is_owner
from YUVICHATBOT import mongo
...
import time
import io
from YUVICHATBOT import CLONE_OWNERS, db, YUVICHATBOT
...
from YUVICHATBOT.database.clonestats import get_served_cchats, get_served_cusers, add_served_cuser, add_served_cchat
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, CallbackQuery
from YUVICHATBOT.idchatbot.helpers import (
    START,
    START_BOT,
    PNG_BTN,
    CLOSE_BTN,
...
async def add_bot_to_chats():
    try:
        ...
        bot = await YUVICHATBOT.get_users(users)
        bot_id = bot.id
