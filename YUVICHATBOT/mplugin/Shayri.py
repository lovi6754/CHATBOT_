import random
from YUVICHATBOT.database import get_served_chats
...
async def shayri(client: Client, message: Message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("❍ 𝐔ᴘᴅᴀᴛᴇ ❍", url="https://t.me/+u7vH0v-mNjk1YmFl"),
                    InlineKeyboardButton("❍ 𝐒ᴜᴘᴘᴏʀᴛ ❍", url="https://t.me/+WY5qffrfZ1tjNTQ1"),
                ]
           ]
        ),
    )
