...
from YUVICHATBOT import YUVICHATBOT as app, save_clonebot_owner, save_idclonebot_owner
from YUVICHATBOT import YUVICHATBOT, db as mongodb
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                no_updates=False,
                plugins=dict(root="YUVICHATBOT.idchatbot"),
            )
            await ai.start()
