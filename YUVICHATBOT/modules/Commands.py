...
from YUVICHATBOT.database.chats import add_served_chat
from YUVICHATBOT.database.users import add_served_user
from config import MONGO_URL, OWNER_ID
from YUVICHATBOT import YUVICHATBOT, mongo, LOGGER, db
from YUVICHATBOT.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@YUVICHATBOT.on_message(filters.command(["lang", "language", "setlang"]))
...
@YUVICHATBOT.on_message(filters.command("status"))
...
@YUVICHATBOT.on_message(filters.command(["resetlang", "nolang"]))
...
@YUVICHATBOT.on_message(filters.command("chatbot"))
